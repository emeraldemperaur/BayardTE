...
class SunDial {
    ...
    fun fetchCopyrightYear(): String {
     ...
     fun fetchHourTime(): String {
        val localDateTime = LocalDateTime.now()

        return localDateTime.format(DateTimeFormatter.ofPattern("hh"))
    }

    fun fetchMinuteTime(): String {
        val localDateTime = LocalDateTime.now()

        return localDateTime.format(DateTimeFormatter.ofPattern("mm"))
    }
